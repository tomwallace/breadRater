	...
	<body>
		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${loafInstanceList}" status="i" var="loafInstance">
					<li>
						<g:link action="show" id="${loafInstance.id}">${loafInstance}</g:link>
						<g:link action="edit" id="${loafInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
			<fieldset class="pagination">
				<g:paginate total="${loafInstanceTotal}" />
			</fieldset>
		</div>
